...
from . import (
    FairseqEncoder, FairseqEncoderDecoderGanModel,
...
from fairseq.modules import (
    AdaptiveSoftmax, MultiheadAttention, LearnedPositionalEmbedding
)
...
class Transformer_nonautoregressive_gan(FairseqEncoderDecoderGanModel):
    def __init__(self, args, encoder, g_decoder, d_decoder, decoder_embed_tokens, tgt_dict):
        super().__init__(args, encoder, g_decoder, d_decoder, decoder_embed_tokens, tgt_dict)
